...
import { ArrowLeft, Camera, Building } from "lucide-react";
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 text-center shadow-sm">
            ...
            <p className="text-gray-600 dark:text-gray-400">Professional product shots for e-commerce</p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 text-center shadow-sm">
            ...
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Corporate Photography</h3>
            <p className="text-gray-600 dark:text-gray-400">Professional business and team photos</p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 text-center shadow-sm">
            ...
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Brand Photography</h3>
            <p className="text-gray-600 dark:text-gray-400">Visual storytelling for your brand</p>
          </div>
        </div>

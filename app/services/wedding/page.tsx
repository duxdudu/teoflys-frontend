      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 text-center shadow-sm">
            ...
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Professional Equipment</h3>
            <p className="text-gray-600 dark:text-gray-400">High-quality cameras and lenses for stunning results</p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 text-center shadow-sm">
            ...
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Wedding Packages</h3>
            <p className="text-gray-600 dark:text-gray-400">From basic to luxury packages for every budget</p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 text-center shadow-sm">
            ...
            <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Quick Delivery</h3>
            <p className="text-gray-600 dark:text-gray-400">Fast turnaround times for your precious memories</p>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white rounded-lg p-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
            <a 
              ...
              className="flex items-center space-x-2 bg-white text-yellow-600 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors"
            >
              <span>Call Now</span>
            </a>
            <a 
